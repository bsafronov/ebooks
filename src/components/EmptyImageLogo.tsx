const EmptyImageLogo = () => {
  return (
    <svg
      className="absolute w-3/4 aspect-square text-slate-300 top-1/2 -translate-x-1/2 left-1/2 -translate-y-1/2"
